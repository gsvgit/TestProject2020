...
[<assembly: AssemblyTitleAttribute("Lecture4")>]
[<assembly: AssemblyProductAttribute("Lecture4")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Lecture4"
    let [<Literal>] AssemblyProduct = "Lecture4"
